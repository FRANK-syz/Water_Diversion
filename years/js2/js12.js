...
option = {
    ...
    series: [{
        name: '总水资源量（单位：亿立方米）',
        type: 'bar',
        data: [4196.35, 2892.36, 2195, 2174.36, 2059.4, 1988.94, 1689.77, 1511.44, 1454.8, 974.02],
        barWidth:'20%', //柱子宽度
       // barGap: 1, //柱子之间间距
        itemStyle: {
            normal: {
...
option = {
    ...
    series: [{
        name: '总水资源量（单位：亿立方米）',
        type: 'bar',
        data: [11.5, 32.94, 33.9, 39.5, 106, 235.53, 265.54, 266.95, 274.3, 364.31],
        barWidth:'20%', //柱子宽度
       // barGap: 1, //柱子之间间距
        itemStyle: {
            normal: {
