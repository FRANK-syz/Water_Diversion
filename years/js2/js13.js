...
option = {
    ...
    series: [{
        name: '总水资源量（单位：亿立方米）',
        type: 'bar',
        data: [4415.74, 2470.27, 2263.17, 2057.33, 1706.69, 1581.97, 1423.99, 1419.58, 1151.9, 959.81],
        barWidth:'20%', //柱子宽度
       // barGap: 1, //柱子之间间距
        itemStyle: {
            normal: {
...
option = {
    ...
    series: [{
        name: '总水资源量（单位：亿立方米）',
        type: 'bar',
        data: [11.4, 14.64, 24.82, 28.03, 126.55, 175.86, 213.07, 268.9, 283.53, 291.7],
        barWidth:'20%', //柱子宽度
       // barGap: 1, //柱子之间间距
        itemStyle: {
            normal: {
