...
option = {
    ...
    series: [{
        name: '总水资源量（单位：亿立方米）',
        type: 'bar',
        data: [4416.3, 2557.66, 1990.9, 1799.42, 1726.63, 1704.5, 1631.81, 1219.62, 1213.12, 1133.85],
        barWidth:'20%', //柱子宽度
       // barGap: 1, //柱子之间间距
        itemStyle: {
            normal: {
...
option = {
    ...
    series: [{
        name: '总水资源量（单位：亿立方米）',
        type: 'bar',
        data: [10.07, 11.37, 21.61, 47.15, 106.16, 111.01, 145.93, 148.44, 198.38, 283.36],
        barWidth:'20%', //柱子宽度
       // barGap: 1, //柱子之间间距
        itemStyle: {
            normal: {
