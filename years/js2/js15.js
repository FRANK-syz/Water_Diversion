...
option = {
    ...
    series: [{
        name: '总水资源量（单位：亿立方米）',
        type: 'bar',
        data: [3853, 2433.6, 2220.5, 2001.2, 1981, 1919.3, 1868, 1430.6, 1325.9, 1153.7],
        barWidth:'20%', //柱子宽度
       // barGap: 1, //柱子之间间距
        itemStyle: {
            normal: {
...
option = {
    ...
    series: [{
        name: '总水资源量（单位：亿立方米）',
        type: 'bar',
        data: [9.2, 12.8, 29.29, 64.1, 94, 135.1, 164.8, 168.4, 179, 198.2],
        barWidth:'20%', //柱子宽度
       // barGap: 1, //柱子之间间距
        itemStyle: {
            normal: {
