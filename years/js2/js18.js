...
option = {
    ...
    series: [{
        name: '总水资源量（单位：亿立方米）',
        type: 'bar',
        data: [4658.2, 2952.6, 2206.5, 1895.1, 1831, 1342.9, 1149.1, 1011.4, 978.7, 961.9],
        barWidth:'20%', //柱子宽度
       // barGap: 1, //柱子之间间距
        itemStyle: {
            normal: {
...
option = {
    ...
    series: [{
        name: '总水资源量（单位：亿立方米）',
        type: 'bar',
        data: [14.54, 17.6, 36.6, 38.7, 121.9, 164.1, 235.4, 339.8, 343.3,343.7],
        barWidth:'20%', //柱子宽度
       // barGap: 1, //柱子之间间距
        itemStyle: {
            normal: {
