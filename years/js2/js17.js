...
option = {
    ...
    series: [{
        name: '总水资源量（单位：亿立方米）',
        type: 'bar',
        data: [4749.9, 2467.1, 2377.3, 2202.6, 1912.4, 1786.6, 1655.1, 1248.8, 1055.6, 1051.5],
        barWidth:'20%', //柱子宽度
       // barGap: 1, //柱子之间间距
        itemStyle: {
            normal: {
...
option = {
    ...
    series: [{
        name: '总水资源量（单位：亿立方米）',
        type: 'bar',
        data: [10.77, 13, 29.8, 34, 130.2, 138.3, 186.3, 225.6, 277.1, 309.9],
        barWidth:'20%', //柱子宽度
       // barGap: 1, //柱子之间间距
        itemStyle: {
            normal: {
