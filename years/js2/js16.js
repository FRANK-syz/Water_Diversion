...
option = {
    ...
    series: [{
        name: '总水资源量（单位：亿立方米）',
        type: 'bar',
        data: [4642.2, 2454.5, 2340.9, 2232.7, 2221.1, 2196.6, 2109, 2089, 1498, 1322],
        barWidth:'20%', //柱子宽度
       // barGap: 1, //柱子之间间距
        itemStyle: {
            normal: {
...
option = {
    ...
    series: [{
        name: '总水资源量（单位：亿立方米）',
        type: 'bar',
        data: [10, 18.9, 35.1, 61, 134.1, 205.53, 208.3, 220.3, 271.5, 331.6],
        barWidth:'20%', //柱子宽度
       // barGap: 1, //柱子之间间距
        itemStyle: {
            normal: {
